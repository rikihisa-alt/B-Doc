...
const NAV_ITEMS_MAP: Record<string, TopNavItem> = {
  ...
  documents: {
    ...
    subItems: [
      { icon: List, label: '文書一覧', href: '/dashboard/documents' },
      { icon: FilePlus, label: '新規作成', href: '/dashboard/documents/new/select-template' },
      { icon: History, label: '発行履歴', href: '/dashboard/documents?status=issued' },
    ],
  },
  approvals: {
    id: 'approvals',
    ...
    badgeCount: 3,
    subItems: [
      { icon: CheckSquare, label: '承認待ち', href: '/dashboard/approvals' },
      { icon: RotateCcw, label: '差戻し一覧', href: '/dashboard/documents?status=returned' },
    ],
  },
  templates: {
    id: 'templates',
    ...
    subItems: [
      { icon: List, label: 'テンプレート一覧', href: '/dashboard/templates' },
      { icon: Plus, label: '新規テンプレート', href: '/dashboard/templates/new' },
      { icon: Stamp, label: '印影管理', href: '/dashboard/master/seals' },
    ],
  },
  master: {
    id: 'master',
    ...
    subItems: [
      { icon: Database, label: 'マスタ管理トップ', href: '/dashboard/master' },
      { icon: Stamp, label: '印影管理', href: '/dashboard/master/seals' },
      { icon: Building2, label: '会社・事業所', href: '/dashboard/master/organizations' },
      { icon: Users, label: '従業員', href: '/dashboard/master/employees' },
    ],
  },
  audit: {
    id: 'audit',
  ...
  settings: {
    ...
    subItems: [
      { icon: Settings, label: '設定トップ', href: '/dashboard/settings' },
      { icon: Lock, label: '権限管理', href: '/dashboard/settings/permissions' },
      { icon: GitBranch, label: '承認フロー', href: '/dashboard/settings/workflows' },
    ],
  },
}
